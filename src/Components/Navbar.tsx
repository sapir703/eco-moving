...
const pages = ['Mange my Deliveries', 'New Delivery', 'Mange my Complaints', 'New Complaint'];
...
function Navbar({user,setUser, auth, googleAuthProvider, setCurrentPage}:NavbarProps) {
                    ...
                    {user ? (
                        ...
                        <Tooltip title={user?.displayName}>
                            <IconButton onClick={handleOpenUserMenu} sx={{p: 0}}>
                                <Avatar alt='User' src={user?.photoURL? user.photoURL : undefined}/>
                            </IconButton>
                        </Tooltip>
                        <Menu
                            sx={{mt: '45px'}}
